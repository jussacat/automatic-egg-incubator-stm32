...
*Ideal parameter: 
- Temperature: 37.5 to 37.8 Celcius Degree
...
- Alerting: If the temperature deviates outside the safe range (>= temp_high or <= temp_low), the buzzer is activated using PWM (Timer 3).
...
Developed By
Group 8, 23DTV_CLC2 - Faculty of Electronics and Telecommunications, University of Science, VNU-HCM
